...
Sample List of  Built In resources
...
Now that we learnt the resource syntax, and created a manifest, lets add a few more resource to our existing manifest and apply.  
